# 📣 Student Notifications — Specification-Driven Development (SDD)
...
- ✅ Receive notifications generated by system events
- ✅ View notifications in a dedicated page
- ✅ See unread vs read state
- ✅ Mark notifications as read
- ✅ Navigate back to the correct enrollment context
- ✅ Have all notification behavior gated by `StudentPreferences`
...
- ❌ Admin / Pembina notification UI (will come later)
- ❌ Notification settings beyond existing toggles
...
- ❌ NO `/student/notifications/[id]`
- ❌ NO `/student/announcement/[id]`
- ❌ NO `/student/session/[id]`

### ✅ All notification clicks MUST navigate to
...
3. If disabled → **DO NOT CREATE notification**
...
- If unread count > 0 → badge visible

### Click Behavior (Choose ONE — MVP Allowed)
...
👉 Clicking the bell **MUST** allow the student to access notifications.
...
- A student can see other users’ notifications
