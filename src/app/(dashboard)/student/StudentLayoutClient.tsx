/**
 * Student Dashboard Layout - Client Component
 *
 * Client-side layout component for Student (SISWA) role with navigation.
 * Receives unreadNotificationCount from server parent.
 *
 * @module app/(dashboard)/student/StudentLayoutClient
 */
