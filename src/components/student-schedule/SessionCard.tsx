...
const categoryColors: Record<string, string> = {
  Olahraga: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",
  ...
  Akademik: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400",
...
export function SessionCard({ session }: SessionCardProps) {
  const categoryClass = categoryColors[session.extracurricular.category] || 
